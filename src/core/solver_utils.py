...
def calculate_expected_rq_wo_curr_move(probs, gss_costs):
    # TODO: consider np weighted mean or matrix multiplication.
    (p_False, p_True) = probs
    ((rounds_False, queries_False), (rounds_True, queries_True)) = gss_costs
