...
def calculate_actual_expected_for_capitulation(evaluations_cache, game_state: Game_State):
    ...
    cost_false = calculate_actual_expected_for_capitulation(evaluations_cache, gs_false)
    cost_true = calculate_actual_expected_for_capitulation(evaluations_cache, gs_true)
...
class Solver_Capitulate(Solver):
    ...
    def calculate_best_move(self, qs_dict, game_state):
        ...
        calculate_actual_expected_for_capitulation(self.evaluations_cache, self.initial_game_state)
